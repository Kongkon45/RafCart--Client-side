        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='lg:flex w-full mt-6'>
                    <div className='lg:w-2/4 w-full mx-auto px-10'>
                    ...
                    <div className='lg:w-1/4 w-full mx-auto px-10'>
                        ...
                        <div className='mt-6 border-2 rounded-lg p-4'>
                            ...
                            <div className='mt-6 mb-2'>
                                ...
                                <div className='flex items-center gap-2 mt-6'>
                                    <input className='w-5 h-5' type="checkbox" {...register("checkbox", {required : true})} />
                                    <label htmlFor="checkbox">Agree to our Terms & Conditons</label>
                                </div>
                                {errors.checkbox && <span className='text-[#fd3d57]'>This field is required</span>}
