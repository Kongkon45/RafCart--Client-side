            ...
            <div className="grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 gap-10">
            {
                categoriesData?.map((category)=>{
                    return <div key={category.id}>
                        <Image className=" rounded-full border border-[#fd3d57] p-4 shadow-lg hover:scale-110 duration-300 cursor-pointer transtion ease-in-out" src={category.images} alt={category.name} width={150} height={150}/>
